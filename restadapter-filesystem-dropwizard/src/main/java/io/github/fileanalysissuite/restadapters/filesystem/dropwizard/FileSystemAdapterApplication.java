...
public final class FileSystemAdapterApplication extends Application<FileSystemAdapterConfiguration>
{
    private FileSystemAdapterApplication()
    {
    }

    public static void main(final String[] args) throws Exception
    {
        new FileSystemAdapterApplication().run(args);
    }

    @Override
    public void run(
        final FileSystemAdapterConfiguration configuration,
